function SectionTitle({ children }) {
  return (
    <h2 className="mb-4 mt-12 text-2xl font-semibold text-primary-800">
      {children}
    </h2>
  );
}
function SubSectionTitle({ children }) {
  return (
    <h3 className="mb-2 mt-8 text-xl font-medium text-primary-700">
      {children}
    </h3>
  );
}
    ...
    <div className="mt-20 min-h-screen bg-primary-50">
      <div className="mx-auto max-w-4xl px-6 py-16 text-primary-900 sm:px-12">
        ...
        <ul className="mb-6 list-disc space-y-2 pl-6">
          ...
          <li>
            <b>Website</b> refers to Cuddle Corners, accessible from{" "}
            <a
              href="https://cuddlecorners.com/"
              className="text-secondary-600 underline"
            >
              https://cuddlecorners.com/
            </a>
          </li>
          <li>
